      ...
      var o = {
        ...
        components: {
          wxParseTemplate: function wxParseTemplate() {
            t.e("components/uParse/src/components/wxParseTemplate1")
              .then(
                function () {
                  return resolve(t("53bd"));
                }.bind(null, t)
              )
              .catch(t.oe);
          },
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ...
  {
    "components/uParse/src/components/wxParseTemplate0-create-component":
      function componentsUParseSrcComponentsWxParseTemplate0CreateComponent(
        module,
        exports,
        __webpack_require__
      ) {
