      ...
      var o = {
        ...
        components: {
          wxParseTemplate: function wxParseTemplate() {
            t.e("components/uParse/src/components/wxParseTemplate8")
              .then(
                function () {
                  return resolve(t("0265"));
                }.bind(null, t)
              )
              .catch(t.oe);
          },
...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ...
  {
    "components/uParse/src/components/wxParseTemplate7-create-component":
      function componentsUParseSrcComponentsWxParseTemplate7CreateComponent(
        module,
        exports,
        __webpack_require__
      ) {
